...
buildDir = "dist"; // Build directory path without «/» at the end
...
let paths = {
  ...
  libs: {
    src: ["node_modules/inputmask/dist/inputmask.min.js"],
    dest: buildDir + "/js",
  },
  images: {
    src: [
      baseDir + "!/img/sprite/**/*",
      baseDir + "/img/**/*.{jpg,jpeg,png,svg,webp}",
    ],
    dest: buildDir + "/img",
  },
  sprites: {
...
function styles() {
  return src(paths.styles.src)
    ...
    .pipe(
      autoprefixer({ overrideBrowserslist: ["last 8 versions"], grid: true }),
    )
